...
public class UserControllerTest {
    ...
    public void putUser_whenUnauthorizedUserSendsTheRequest_receiveUnauthorized() {
        ResponseEntity<Object> response = putUser(123L, null, Object.class);
        assertThat(response.getStatusCode()).isEqualTo(HttpStatus.UNAUTHORIZED);
    }

    @Test
    public void putUser_whenAuthorizedUserSendsTheRequestForAnotherUser_receiveForbidden() {
    ...
    public void putUser_whenUnauthorizedUserSendsTheRequest_receiveApiError() {
        ResponseEntity<ApiError> response = putUser(123L, null, ApiError.class);
        assertThat(response.getBody().getUrl()).contains("users/123");
    }

    @Test
    public void putUser_whenAuthorizedUserSendsTheRequestForAnotherUser_receiveApiError() {
        User user = userService.save(TestUtil.createValidUser("user1"));
        authenticate("user1");
    ...
    @Test
    public void putUser_withInvalidRequestBodyWithNullDisplayNameFromAuthorizedUser_returnBadRequest() throws IOException {
        User user = userService.save(TestUtil.createValidUser("user1"));
        authenticate("user1");
    ...
    @Test
    public void putUser_withInvalidRequestBodyWithLessThanMiniumSizeDisplayNameFromAuthorizedUser_returnBadRequest() throws IOException {
        User user = userService.save(TestUtil.createValidUser("user1"));
        authenticate("user1");
        UserUpdateVM updatedUser = new UserUpdateVM();
    ...
    @Test
    public void putUser_withInvalidRequestBodyWithMoreThanMaximumSizeDisplayNameFromAuthorizedUser_returnBadRequest() throws IOException {
        User user = userService.save(TestUtil.createValidUser("user1"));
        authenticate("user1");
        UserUpdateVM updatedUser = new UserUpdateVM();
        String valueOf256Chars = IntStream.rangeClosed(1, 256).mapToObj(x -> "a").collect(Collectors.joining());
    ...
    public void putUser_withValidRequestBodyWithJPGImageFromAuthorizedUser_receiveOk() throws IOException {
        ...
        authenticate("user1");
        UserUpdateVM updatedUser = TestUtil.createValidUserUpdateVM();
        String imageString = readFileToBase64("testjpg.jpg");
        updatedUser.setImage(imageString);
    ...
    public void putUser_withValidRequestBodyWithTXTImageFromAuthorizedUser_receiveValidationErrorForProfileImage() throws IOException {
        ...
        authenticate("user1");
        UserUpdateVM updatedUser = TestUtil.createValidUserUpdateVM();
        String imageString = readFileToBase64("testtxt.txt");
        updatedUser.setImage(imageString);
